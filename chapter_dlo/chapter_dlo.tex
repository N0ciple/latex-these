...
using gradient-based me\-thods which rely on the iterative adjustment of the
...
leading to the cross-corre\-la\-tion not being commutative
...
datasets tailored for image classification: \mbox{CIFAR-10} \cite{CIFARdataset},
