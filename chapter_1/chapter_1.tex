...
\ac{batch norm} \cite{DBLP:conf/icml/IoffeS15}. It induces sparsity with $\ell_1$
...
it allows reaching a targeted pruning budget in a more convenient way than $\ell_1$
...
Where $||~.~||_1$ represents the $\ell_1$ norm, and $N$ is the total number of
...
minimal impact on the performance if no fine-tuning is applied. While the $\ell_1$
