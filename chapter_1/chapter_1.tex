...
\subfloat[Conv4 CIFAR10\label{fig:chap1:finetuning_impact_conv4_cifar10}]{
  ...
  \caption{\centering Finetuning of a Conv4 network pruned by magnitude pruning
...
\subfloat[ResNet20 CIFAR10\label{fig:chap1:finetuning_impact_resnet20_cifar10}]{
  ...
  \caption{\centering Finetuning of a ResNet20 network pruned by magnitude
...
\begin{figure}
  ...
  \subfloat[Conv4 CIFAR10\label{fig:chap1:no_budget_conv4_cifar10}]{
    ...
    \caption{\centering Comparison of the performance of our method (\emph{Ours})}
