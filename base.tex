...
% \usepackage{xr} % Pour pouvoir référencer les chapitres entre eux (voir ici: https://tex.stackexchange.com/questions/14364/cross-referencing-between-different-files)
...
% \input{./chapter_intro/chapter_into.tex}

\linenumbers

% \input{./chapter_context/chapter_context.tex}
