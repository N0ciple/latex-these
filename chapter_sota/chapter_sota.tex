...
% In summary, although pruning presents certain challenges, this thesis introduces
% new methods and perspectives that contribute to mitigating these issues, thus
% enhancing the overall efficacy and practicality of neural network compression.\\
