...
\begin{itemize}
  ...
  be applied in conjunction with them, on any kind of architectures.
...
effective pruning and does not require fine-tuning. Furthermore,
...
also sidestepping the fine-tuning. Contrary to other methods, the optimal
