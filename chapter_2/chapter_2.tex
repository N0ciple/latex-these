...
the method presented in this chapter relies on training latent masks that
represent a parametrisation of the probabilities for the weights to be selected
on not in a sampled set of weights. Unlike the method described in
...
Bernoulli distribution parametrised by $m$, that either select or prunes the
...
value of $k$. This value if the same for all the layer, imposing a constant
