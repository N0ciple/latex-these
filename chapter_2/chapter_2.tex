...
the baseline scenario (refered to as $\varnothing$). This improvement is
...
data augmentation in both cases. The number of epoch is set to 1000 and an early
...
substantial overhead at each training epoch. On the other hand, \ac{SR} nvolves
